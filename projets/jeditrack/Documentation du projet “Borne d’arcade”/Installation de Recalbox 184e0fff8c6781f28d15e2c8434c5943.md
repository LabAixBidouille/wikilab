...
1. Rendez-vous sur le site officiel de **Recalbox** : https://www.recalbox.com/fr/
2. Cliquez sur le bouton **Télécharger :** https://www.recalbox.com/fr/download/stable/
...
2. **Flash l’image sur la carte microSD :** Utilisez un logiciel comme **Etcher** (téléchargeable ici : [https://www.balena.io/etcher/](https://www.balena.io/etcher/)) pour flasher l'image Recalbox sur votre carte microSD. Voici les étapes à suivre :
    - Ouvrez **Etcher**.
