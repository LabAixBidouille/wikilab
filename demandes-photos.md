...
- `programmation-indoor-air-quality` — Capteur CO2 intérieur
- `programmation-insulation` — Mesure d
- `programmation-outdoor-air-quality` — Station air extérieur
- `programmation-road-signs` — Reconnaissance de panneaux par IA
- `programmation-sound-squad` — Carte sonore avec micro:bit
...
- `programmation-distraction-temps-reaction` — Test de distraction STM32
- `programmation-ocean-sale` — Conductimètre STM32
- `programmation-panneau-solaire-auto-orientable` — Panneau solaire orientable STM32
- `programmation-panneau-solaire-journee` — Suivi panneau solaire STM32
- `programmation-plante-co2` — Capteur CO2 plantes STM32
- `programmation-qualite-air-personnes` — Capteur CO2 classe STM32
- `programmation-solution-meteo` — Station météo STM32
...
- `insulation` — Isolation des murs et villes fraîches
