...
<img src="/img/photos/machines/PXL_20260420_085023396.jpg" alt="Oscilloscope Rigol DS1104Z" style={{width: '225px', height: '225px', objectFit: 'contain', flexShrink: 0, borderRadius: '10px', background: '#f5f5f5', padding: '0.5rem'}} />
...
- [Manuel utilisateur Rigol DS1000Z (PDF)](https://www.batronix.com/pdf/Rigol/UserGuide/DS1000Z_UserGuide_EN.pdf) — Documentation complète
- [Tutoriel oscilloscope pour débutants — EEVblog (vidéo)](https://www.youtube.com/watch?v=xaELqAo4kkQ) — Prise en main pas à pas
- [Comprendre la communication série — Sparkfun](https://learn.sparkfun.com/tutorials/serial-communication) — Analyser UART, SPI et I2C
