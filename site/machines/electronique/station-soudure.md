...
<img src="/img/photos/machines/PXL_20260420_085047621.jpg" alt="Stations de soudure" style={{width: '225px', height: '225px', objectFit: 'contain', flexShrink: 0, borderRadius: '10px', background: '#f5f5f5', padding: '0.5rem'}} />
