...
<img src="/img/photos/machines/PXL_20260420_085055152.jpg" alt="Microscope numérique" style={{width: '225px', height: '225px', objectFit: 'contain', flexShrink: 0, borderRadius: '10px', background: '#f5f5f5', padding: '0.5rem'}} />
...
- [Identifier les défauts de soudure — Adafruit](https://learn.adafruit.com/adafruit-guide-excellent-soldering/common-problems) — Photos de joints corrects et défectueux
- [Critères d'acceptation des joints — CircuitRework](https://www.circuitrework.com/guides/7-1-3.html) — Guide visuel d'inspection CMS et traversant
- [Guide de soudure CMS — Adafruit](https://learn.adafruit.com/adafruit-guide-excellent-soldering/surface-mount?view=all) — Techniques et inspection au microscope
