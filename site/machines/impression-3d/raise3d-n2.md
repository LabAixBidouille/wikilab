...
<img src="/img/photos/machines/PXL_20260420_084453333.MP.jpg" alt="Raise3D N2" style={{width: '225px', height: '225px', objectFit: 'contain', flexShrink: 0, borderRadius: '10px', background: '#f5f5f5', padding: '0.5rem'}} />
...
- [Guide de la double extrusion — All3DP](https://all3dp.com/2/dual-extruder-extrusion-3d-printer-simply-explained/) — Comprendre l'impression double tête (en anglais)
