...
|---|---|---|---|
| Robots Meet Arts | 120 min | Débutant | 8 - 12 ans |
...
<PdfLink href="/pdf/robots-meet-arts/RMA_OctoStudioPremiersPas_FR.pdf">Télécharger en PDF</PdfLink>
...
- Source d'inspiration pour cette séance : atelier _Animate a Shape_ de l'Exploratorium (Tinkering Studio, exploratorium.edu)
