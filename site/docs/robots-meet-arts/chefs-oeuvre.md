...
# <svg viewBox="0 0 24 24" width="36" height="36" style={{verticalAlign: 'middle', marginRight: '0.5rem', marginBottom: '4px'}}><rect x="2" y="3" width="9" height="8" rx="1" fill="#169da7" opacity="0.1"/><rect x="13" y="3" width="9" height="8" rx="1" fill="#169da7" opacity="0.1"/><rect x="2" y="13" width="9" height="8" rx="1" fill="#169da7" opacity="0.1"/><rect x="13" y="13" width="9" height="8" rx="1" fill="#169da7" opacity="0.1"/><rect x="3" y="4" width="7" height="6" rx="0.5" fill="#169da7" opacity="0.25"/><circle cx="6.5" cy="7" r="2" fill="#169da7"/><rect x="14" y="14" width="7" height="6" rx="0.5" fill="#169da7" opacity="0.25"/><circle cx="17.5" cy="17" r="2" fill="#169da7"/><text x="16" y="8" fontSize="4" fill="#169da7" opacity="0.25">?</text><text x="5" y="18" fontSize="4" fill="#169da7" opacity="0.25">?</text></svg> Mémoire des chefs-d'œuvre
...
<div style={{display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '1rem'}}>
  ...
  <span className="badge badge--secondary">Robot de sol</span>
</div>

| Projet | Durée | Difficulté | Âge |
|---|---|---|---|
| Robots Meet Arts | 120 min | Intermédiaire | 10 - 12 ans |
...
<PdfLink href="/pdf/robots-meet-arts/RMA_ChefsOeuvre_FR.pdf">Télécharger en PDF</PdfLink>
...
**Astuce : utiliser Google Lens pour identifier les œuvres**
