...
<div style={{display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '1rem'}}>
  ...
  <span className="badge badge--primary">Compétences numériques</span>
  <span className="badge badge--info">Activité débranchée puis Scratch</span>
</div>

| Projet | Durée | Difficulté | Âge |
|---|---|---|---|
| Robots Meet Arts | 180 - 270 min (3 à 4 séances) | Intermédiaire | 8-12 ans |
...
<a href="/pdf/robots-meet-arts/RMA_MissionVoyageursTemps_FR.pdf" target="_blank" style={{display: 'inline-block', backgroundColor: '#e83e8c', color: '#fff', borderRadius: '20px', padding: '0.5rem 1.5rem', fontWeight: 700, textDecoration: 'none', fontSize: '0.95rem'}}>Télécharger en PDF</a>

</div>


<img src="/img/ressources/robots-meet-arts/mission-voyageurs-temps/icone.png" alt="Voyageurs du temps" style={{width: '225px', height: '225px', objectFit: 'contain', flexShrink: 0}} />
