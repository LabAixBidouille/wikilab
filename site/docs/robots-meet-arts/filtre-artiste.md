...
sidebar_label: "Filtre d'artiste"
sidebar_position: 12
---
...
|---|---|---|---|
| Robots Meet Arts | 150-180 min (2 à 3 séances) | Intermédiaire | 8 - 12 ans |
...
- Fiche modèle vierge pour la conception du filtre
- Solutions de programmation

:::

<a href="/pdf/robots-meet-arts/RMA_FiltreArtiste_FR.pdf" target="_blank" style={{display: 'inline-block', backgroundColor: '#e83e8c', color: '#fff', borderRadius: '20px', padding: '0.5rem 1.5rem', fontWeight: 700, textDecoration: 'none', fontSize: '0.95rem'}}>Télécharger en PDF</a>
