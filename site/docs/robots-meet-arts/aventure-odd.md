...
# <svg viewBox="0 0 24 24" width="36" height="36" style={{verticalAlign: 'middle', marginRight: '0.5rem', marginBottom: '4px'}}><circle cx="12" cy="12" r="10" fill="#169da7" opacity="0.1"/><circle cx="12" cy="12" r="7" fill="#169da7" opacity="0.25"/><path d="M12 5 L13.5 9.5 L18 9.5 L14.5 12.5 L16 17 L12 14 L8 17 L9.5 12.5 L6 9.5 L10.5 9.5 Z" fill="#169da7"/><rect x="3" y="19" width="4" height="3" rx="0.5" fill="#169da7" opacity="0.25"/><rect x="10" y="18" width="4" height="4" rx="0.5" fill="#169da7" opacity="0.25"/><rect x="17" y="17" width="4" height="5" rx="0.5" fill="#169da7" opacity="0.25"/></svg> L'aventure des ODD
...
|---|---|---|---|
| Robots Meet Arts | 2h30 - 3h00 | Avancé | 7 - 12 ans |
...
- Pictogrammes ODD (versions sans texte et avec texte)

:::

<a href="/pdf/robots-meet-arts/RMA_AventureODD_FR.pdf" target="_blank" style={{display: 'inline-block', backgroundColor: '#e83e8c', color: '#fff', borderRadius: '20px', padding: '0.5rem 1.5rem', fontWeight: 700, textDecoration: 'none', fontSize: '0.95rem'}}>Télécharger en PDF</a>
...
> « Il était une fois un·e héros/héroïne nommé·e \_\_\_, animé·e par \_\_\_. Il/Elle tenait à \_\_\_ et défendait toujours \_\_\_. Notre héros/héroïne était connu·e pour des qualités comme \_\_\_ et possédait le pouvoir spécial de \_\_\_. Mais même les héros ont leurs faiblesses, et la sienne était \_\_\_. »
