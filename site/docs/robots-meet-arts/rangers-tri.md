...
|---|---|---|---|
| Robots Meet Arts | 60 - 80 min | Débutant | 6-10 ans |
...
<PdfLink href="/pdf/robots-meet-arts/RMA_RangersTri_FR.pdf">Télécharger en PDF</PdfLink>
...
- Utiliser correctement le mode impératif.
...
- Informations sur le recyclage et le réemploi : https://www.lifewithnogarbage.gr/
- https://inactionforabetterworld.com/en/in-action/
- [Wordwall : Recyclage](https://wordwall.net/el/resource/26398760/)
- Notions de base en robotique (Bee-Bot) : https://beebot.terrapinlogo.com/
