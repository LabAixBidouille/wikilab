...
<div style={{display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '1rem'}}>
  ...
  <span className="badge badge--primary">Esprit critique</span>
...
|---|---|---|---|
| Youth AI Lab | 3 à 4 séances | Intermédiaire | 12-18 ans |
...
<img src="/img/ressources/youth-ai-lab/air-vrai-est-ce-vrai/icone.png" alt="Vrai ou faux selon l'IA ?" style={{width: '225px', height: '225px', objectFit: 'contain', flexShrink: 0}} />
...
- Définir l'**IA générative** avec ses propres mots, en s'appuyant sur des exemples et des limites
- Expliquer que l'IA générative **prédit et produit** du texte/des images/etc. à partir de **modèles statistiques**, et non d'une « connaissance de la vérité »
- Appliquer des **vérifications éthiques** : exactitude, biais/équité, vie privée, transparence et intégrité académique
- Identifier au moins 3 **usages inclusifs** (accessibilité, soutien linguistique, aide à l'apprentissage) et au moins 3 **risques**
...
- Indiquer l'incertitude et les informations potentiellement manquantes
...
- **Checklist de prompting** : Comment demander des productions plus claires, plus précises et plus inclusives
- **Checklist d'évaluation** : Questions pour évaluer l'exactitude, la fiabilité, les biais/l'équité, la transparence et l'usage responsable
