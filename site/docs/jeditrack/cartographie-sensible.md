...
|---|---|---|---|
| JediTrack | ~2h | Débutant | 8-18 ans |

## Matériel

- Papier blanc et/ou coloré (ou cartes existantes comme base)
- Crayons, feutres, pastels
- Gommettes, magazines à découper
- Ciseaux, colle
- Espace d'accrochage pour les productions
- Appareil photo pour documenter

</div>


<img src="/img/ressources/jeditrack/cartographie-sensible/icone.png" alt="Cartographie sensible du quartier" style={{width: '225px', height: '225px', objectFit: 'contain', flexShrink: 0}} />
