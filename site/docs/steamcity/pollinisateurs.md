...
| | |
|---|---|
| Disciplines | biologie ; géographie |
| Durée | Deux séquences (formulation d'hypothèses + construction de pièges, puis collecte et analyse des données) |
| Niveau de difficulté | Moyenne |
| Matériel | Une carte imprimée des lieux de l'expérience, des punaises, deux bouteilles en plastique par groupe, du sirop ou une solution eau-sucre, des branchages ou feuilles, des ciseaux, du ruban adhésif et une boussole (optionnelle) |
...
Recherche documentaire préliminaire : Avant de mettre en place les expériences, les élèves effectuent une revue de la littérature pour déterminer si des articles traitent de questions similaires.

Élaboration du protocole expérimental : Le protocole suit la méthode scientifique :
...
Placement des pièges : Les pièges sont placés aux emplacements définis lors de la cartographie, en tenant compte des variables environnementales. Les élèves doivent documenter les coordonnées, prendre des photos horodatées, et effectuer des observations initiales.
...
1. L'organisation des données : Tableaux dans un logiciel de tableur.
2. L'analyse statistique : Moyennes, médianes, tendances, variance et étendue.
3. La représentation visuelle : Graphiques à barres, diagrammes de dispersion, cartes.
