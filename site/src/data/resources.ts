...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    title: 'Utiliser des boutons-poussoirs',
    slug: '/ressources/inovmicro-exao/i03-boutons-poussoirs',
    project: 'inovmicro-exao',
    summary:
      "Programmer un jeu de questions-réponses en MicroPython avec les boutons A et B intégrés à la STeaMi : détection de transition, variable booléenne pour gérer l'état du jeu, affichage du gagnant sur l'écran OLED et la LED RGB — sans aucun câblage.",
    disciplines: ['informatique', 'technologie'],
    tools: ['steami'],
    software: ['python'],
    ageMin: 11,
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i03-boutons-poussoirs/icone.png',
    section: 'Apprentissage de la programmation',
  },
  {
