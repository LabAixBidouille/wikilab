...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    project: 'inovmicro-exao',
    summary:
      "Programmer une alarme de mouvement avec le capteur de proximité APDS-9960 de la STeaMi : déclencher une alerte sonore et visuelle (buzzer + LED RGB) lorsqu'un mouvement est détecté à moins de 20 cm.",
    disciplines: ['informatique', 'technologie'],
    tools: ['steami'],
    software: ['python'],
    ageMin: 11,
    ...
    formats: ['programmation'],
    categories: ['programmation'],
    keywords: ['STeaMi', 'MicroPython', 'alarme', 'mouvement', 'APDS-9960', 'I2C'],
