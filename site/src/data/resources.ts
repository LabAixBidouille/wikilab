...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    project: 'inovmicro-exao',
    summary:
      "Mettre en place un environnement desktop, gratuit et hors-ligne pour programmer la STeaMi en MicroPython avec Thonny : installation, flash du firmware, configuration de l'interpréteur, et premier programme LED RGB + boutons.",
    disciplines: ['informatique', 'technologie', 'sciences'],
    tools: ['steami'],
    software: ['python'],
    ageMin: 11,
    ...
    formats: ['programmation'],
    categories: ['programmation'],
    keywords: ['STeaMi', 'STM32', 'MicroPython', 'Thonny', 'REPL', 'firmware', 'DAPLink'],
