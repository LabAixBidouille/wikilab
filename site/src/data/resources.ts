...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    pdf: '/pdf/youth-ai-lab/YouthAiLab_Explorations_Ideation_Sheet_TheStupidInvention.pdf',
    thumbnail: '/img/ressources/youth-ai-lab/pire-invention/icone.png',
  },
  {
    id: 'enqueter-machines-apprennent',
    title: 'Enquêter sur la façon dont les machines apprennent',
    slug: '/ressources/youth-ai-lab/enqueter-machines-apprennent',
    project: 'youth-ai-lab',
    summary:
      "Trier des objets du quotidien entre IA et automatisation, incarner un modèle qui apprend une règle secrète uniquement à partir d'exemples, puis entraîner un vrai classifieur avec Teachable Machine et le mettre en défaut.",
    disciplines: ['informatique', 'sciences', 'education-civique'],
    tools: ['debranchee', 'demarche-scientifique'],
    software: [],
    ageMin: 12,
    ageMax: 18,
    durationMinutes: 180,
    difficulty: 'debutant',
    formats: ['enquete', 'debranchee', 'experimentation'],
    categories: ['animation-jeunesse', 'ia-esprit-critique'],
    keywords: [
      'apprentissage supervisé',
      'automatisation',
    ...
    pdf: '/pdf/youth-ai-lab/YouthAiLab_Ideation_Sheet_UAB_AI_Detectives.pdf',
    thumbnail: '/img/ressources/youth-ai-lab/enqueter-machines-apprennent/icone.png',
  },
  {
    id: 'entrainer-cerveau-machine',
    title: 'Entraîner le cerveau de la machine',
    slug: '/ressources/youth-ai-lab/entrainer-cerveau-machine',
    project: 'youth-ai-lab',
    summary:
      "Entraîner un classifieur puis chercher à le casser avec des cas limites, construire un perceptron en gobelets d'eau pour voir un neurone décider, et imaginer un usage social de l'IA relié aux ODD.",
    disciplines: ['informatique', 'sciences', 'education-civique'],
    tools: ['debranchee', 'demarche-scientifique'],
    software: [],
    ageMin: 12,
    ...
    durationMinutes: 170,
    difficulty: 'intermediaire',
    formats: ['experimentation', 'debranchee'],
    categories: ['animation-jeunesse', 'ia-esprit-critique', 'exploration-scientifique'],
    keywords: [
      'perceptron',
      'réseau de neurones',
      'cas limites',
    ...
    pdf: '/pdf/youth-ai-lab/YouthAiLab_Ideation_Sheet_UAB_MachineBrain.pdf',
    thumbnail: '/img/ressources/youth-ai-lab/entrainer-cerveau-machine/icone.png',
  },
  {
    id: 'concevoir-ia-avec-robot',
    title: 'Concevoir une IA avec un robot',
    slug: '/ressources/youth-ai-lab/concevoir-ia-avec-robot',
    project: 'youth-ai-lab',
    summary:
      "Suivre les premières étapes du design thinking (carte d'empathie, question « Comment pourrions-nous... ? », idéation, prototype) pour transformer un défi lié à un ODD en un système IA + robot viable.",
    disciplines: ['informatique', 'technologie', 'education-civique'],
    tools: ['robotique', 'demarche-scientifique'],
    software: [],
    ageMin: 12,
    ageMax: 18,
    durationMinutes: 180,
    ...
    pdf: '/pdf/youth-ai-lab/YouthAiLab_Ideation_Sheet_UAB_RobotAiDesigning.pdf',
    thumbnail: '/img/ressources/youth-ai-lab/concevoir-ia-avec-robot/icone.png',
  },
  {
    id: 'traquer-biais-genre',
    title: "Traquer les biais de genre de l'IA",
    slug: '/ressources/youth-ai-lab/traquer-biais-genre',
    project: 'youth-ai-lab',
    summary:
      "Relier l'ODD 5 aux biais des modèles de langage : auditer des droits réels, prendre une IA en flagrant délit de stéréotype de genre, puis constater les limites d'un réseau de neurones qui prétend classer des personnes sur deux nombres.",
    disciplines: ['informatique', 'education-civique'],
    tools: ['ia-generative'],
    software: ['python'],
    ageMin: 12,
    ...
    durationMinutes: 150,
    difficulty: 'intermediaire',
    formats: ['enquete', 'experimentation', 'programmation'],
    categories: ['ia-esprit-critique', 'animation-jeunesse'],
    keywords: [
      'biais de genre',
      'ODD 5',
      'modèle de langage',
    ...
    pdf: '/pdf/youth-ai-lab/YouthAiLab_Explorations_Ideation_Sheet_BIAIS.pdf',
    thumbnail: '/img/ressources/youth-ai-lab/traquer-biais-genre/icone.png',
  },
  {
    id: 'pirater-prompts-biaises',
    title: 'Pirater ses prompts pour déjouer les biais',
    slug: '/ressources/youth-ai-lab/pirater-prompts-biaises',
    project: 'youth-ai-lab',
    summary:
      "Jouer un modèle de langage humain avec une balle pour voir le groupe produire lui-même les stéréotypes, puis dessiner sur affiche l'architecture d'un prompt sous contrainte capable de forcer l'IA à répondre sans biais.",
    disciplines: ['informatique', 'francais', 'education-civique'],
    tools: ['ia-generative', 'debranchee'],
    software: [],
    ageMin: 12,
    ageMax: 18,
    durationMinutes: 70,
    difficulty: 'debutant',
    formats: ['debranchee', 'jeu-de-role'],
    categories: ['ia-esprit-critique', 'animation-jeunesse', 'sequences-debranchees'],
    keywords: [
      'prompt',
      'biais',
      'stéréotypes',
  ...
  },
  {
    ...
    slug: '/ressources/youth-ai-lab/rendre-ville-vivable',
    project: 'youth-ai-lab',
    summary:
      "Auditer un obstacle urbain au regard de l'ODD 11, donner des sens à un robot avec des capteurs de bruit, d'air et de chaleur, puis lire la matrice de confusion d'un modèle qui juge un lieu vivable ou non.",
    disciplines: ['informatique', 'geographie', 'education-civique'],
    tools: ['capteurs', 'demarche-scientifique', 'robotique'],
    software: ['python'],
    ageMin: 12,
    ageMax: 18,
    durationMinutes: 165,
    difficulty: 'intermediaire',
    formats: ['experimentation', 'programmation', 'enquete'],
    categories: ['citoyennete-territoire', 'ia-esprit-critique', 'environnement-nature'],
    keywords: [
      'ODD 11',
      'ville durable',
      'capteurs',
    ...
    pdf: '/pdf/youth-ai-lab/YouthAiLab_Explorations_Ideation_Sheet_CitiesGreat.pdf',
    thumbnail: '/img/ressources/youth-ai-lab/rendre-ville-vivable/icone.png',
  },
  {
    id: 'wikiyouthbot',
    title: 'Construire le chatbot de son quartier',
    slug: '/ressources/youth-ai-lab/wikiyouthbot',
    project: 'youth-ai-lab',
    summary:
      "Session modulable en 5 demi-journées : partir d'un bingo des ODD, adopter une cause locale, démonter des rumeurs, enquêter sur le terrain, puis spécialiser pas à pas un chatbot générique jusqu'à ce qu'il porte la voix et le territoire du groupe.",
    disciplines: ['informatique', 'education-civique', 'francais'],
    tools: ['ia-generative', 'capteurs'],
    software: [],
    ageMin: 12,
    ageMax: 18,
    durationMinutes: 240,
    difficulty: 'intermediaire',
    formats: ['enquete', 'projet-maker', 'jeu-de-role'],
    categories: ['ia-esprit-critique', 'citoyennete-territoire', 'animation-jeunesse'],
    keywords: [
      'chatbot',
      'ODD',
      'bingo',
  ...
  },
  {
    ...
    pdf: '/pdf/magnetics/Magnetics_Microbit.pdf',
    thumbnail: '/img/ressources/magnetics/microbit/icone.png',
  },
  {
    id: 'makecode-stm32',
    ...
    pdf: '/pdf/magnetics/Magnetics_MakeCode_STM32.pdf',
    thumbnail: '/img/ressources/magnetics/makecode-stm32/icone.png',
  },
  {
    id: 'micropython',
  ...
  },
  {
    ...
    formats: ['programmation'],
    categories: ['programmation'],
    keywords: ['STeaMi', 'MicroPython', 'Vittascience', 'REPL', 'éditeur', 'web', 'blocs'],
    thumbnail: '/img/ressources/inovmicro-exao/t05-vittascience/icone.png',
  },
  {
  ...
  },
  {
    id: 'i01-led',
    title: 'Faire clignoter une LED',
    slug: '/ressources/inovmicro-exao/i01-led',
    project: 'inovmicro-exao',
    summary:
    ...
    formats: ['programmation'],
    categories: ['programmation'],
    keywords: ['STeaMi', 'MicroPython', 'LED', 'machine.Pin', 'clignotement', 'sleep_ms'],
    thumbnail: '/img/ressources/inovmicro-exao/i01-led/icone.png',
  },
  {
    ...
    difficulty: 'debutant',
    formats: ['programmation', 'bricolage'],
    categories: ['programmation', 'makers-fabrication'],
    keywords: [
      'STeaMi',
      'MicroPython',
      'breadboard',
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i02-premier-circuit-breadboard/icone.png',
  },
  {
    id: 'i03-boutons',
    title: 'Utiliser des boutons-poussoirs',
    slug: '/ressources/inovmicro-exao/i03-boutons',
    project: 'inovmicro-exao',
    summary:
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i03-boutons/icone.png',
  },
  {
  ...
  },
  {
    ...
    title: 'Contrôler avec un potentiomètre',
    slug: '/ressources/inovmicro-exao/i05-potentiometre',
    project: 'inovmicro-exao',
    summary:
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i05-potentiometre/icone.png',
  },
  {
    id: 'i06-code-morse',
    title: 'Envoyer des messages en code Morse',
  ...
  },
  {
    id: 'i07-musique',
    title: 'Composer une mélodie',
    slug: '/ressources/inovmicro-exao/i07-musique',
    project: 'inovmicro-exao',
    summary:
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i07-musique/icone.png',
  },
  {
    id: 'i08-theremine',
    title: 'Fabriquer un thérémine',
    ...
    difficulty: 'avance',
    formats: ['programmation', 'experimentation'],
    categories: ['programmation', 'arts-creativite'],
    keywords: [
      'STeaMi',
      'MicroPython',
      'thérémine',
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i08-theremine/icone.png',
  },
  {
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i09-inclinaison-accelerometre/icone.png',
  },
  {
    id: 'i10-texte-oled',
  ...
  },
  {
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i11-thermometre-lisible/icone.png',
  },
  {
  ...
  },
  {
    id: 'i13-servomoteur',
    title: 'Animer avec un servomoteur',
    slug: '/ressources/inovmicro-exao/i13-servomoteur',
    project: 'inovmicro-exao',
    summary:
    ...
    difficulty: 'intermediaire',
    formats: ['programmation', 'bricolage'],
    categories: ['programmation', 'robotique-ludique', 'makers-fabrication'],
    keywords: [
      'STeaMi',
      'MicroPython',
      'servomoteur',
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i13-servomoteur/icone.png',
  },
  {
  ...
  },
  {
    ...
    thumbnail: '/img/ressources/inovmicro-exao/i15-collecter-donnees/icone.png',
  },
  {
    id: 'depannage',
  ...
  },
  {
    ...
    thumbnail:
      '/img/ressources/thedexterlab/programmation-panneau-solaire-auto-orientable/icone.svg',
  },
  {
