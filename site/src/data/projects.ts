...
export const projectsInfo: Record<Project, ProjectInfo> = {
  ...
  jeditrack: {
    ...
    photos: [
      '/img/photos/projets/jeditrack/Image-collee.png',
      '/img/photos/projets/jeditrack/image-collee-2.png',
      '/img/photos/projets/jeditrack/image-collee-3.png',
    ],
  ...
  'inovmicro-exao': {
    ...
    photos: [
      '/img/photos/projets/inovmicro-exao/Image-collee.png',
      '/img/photos/projets/inovmicro-exao/image-collee-2.png',
      '/img/photos/projets/inovmicro-exao/image-collee-3.png',
    ],
